...
<div class="tag-view">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3">
            ...
            <span class="inline-block bg-blue-100 text-blue-800 text-xl font-semibold px-4 py-2 rounded-full">
                        ...
                        <div class="p-6 flex-1">
                            ...
                            <?php if ($publication->tags): ?>
                                <div class="flex flex-wrap gap-2">
                                    <?php foreach ($publication->tags as $pubTag): ?>
                                        <a href="<?= Url::to(['/tag/view', 'slug' => $pubTag->slug]) ?>" 
                                           class="text-xs <?= $pubTag->id === $tag->id ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600 hover:bg-blue-100 hover:text-blue-700' ?> px-2 py-1 rounded">
                                            <?= Html::encode($pubTag->name) ?>
                                        </a>
                                    <?php endforeach; ?>
                                </div>
                            <?php endif; ?>
    ...
    <?php else: ?>
        <div class="bg-white rounded-lg shadow-sm p-8 text-center">
            <p class="text-gray-500">Публикации с этим тегом пока отсутствуют.</p>
        </div>
    <?php endif; ?>
